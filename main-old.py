...
def createWidgets(root,top):
    ...
    def create_interaction_frames(container):
        ...
        # Score label
        root.label_score = ttk.Label(frame,text="Score:", font=("Aptos ExtraBold", 14))
        root.label_score.grid(column=0, row=2,sticky="e")
        root.label_score_value = ttk.Label(frame,textvariable=root.score, font=("Aptos ExtraBold", 14))
